#Sobre o jogo:
#O jogo consiste em uma matriz 7x7 onde o jogador coloca 'O' em uma posição desejada, e o sistema coloca 'X' em uma posição aleatória.
#O objetivo é evitar formar uma matriz 2x2 com símbolos iguais. Quem formar uma matriz 2x2 perde o jogo.
#O jogo continua até que alguém forme uma matriz proibida ou o tabuleiro seja preenchido.
